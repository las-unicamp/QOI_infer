...
def plot_distribution_multiple_models(
    predicted_labels: list[list[NDArray]],
...
def main() -> None:
    ...
    # selected_indices = [400, 510, 524]  # Fig 9
    # selected_indices = [28, 77, 138]  # Fig 9
    ...
    # selected_indices = [100, 600, 800]  # Fig 7
    # selected_indices = [0, 750, 1000]  # Fig 8
    selected_indices = [28, 77, 138]  # Fig 9
