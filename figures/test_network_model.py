...
def _plot_lift_drag_moment_test_samples(
    predicted_labels: NDArray, true_labels: NDArray
) -> NoReturn:
    plt.close("all")
...
def _plot_lift_drag_moment(
    predicted_labels: NDArray, true_labels: NDArray, times: NDArray
) -> NoReturn:
    plt.close("all")
    fig, ax = texfig.subplots(ratio=0.34, nrows=1, ncols=3)
...
def _plot_pressure_distribution(
    predicted_labels: NDArray, true_labels: NDArray, images: NDArray
) -> NoReturn:
    plt.close("all")
